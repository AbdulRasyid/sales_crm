...
$header = '     <table border="0" cellspacing="2" cellpadding="3">    
                    ...
                    <tr>
                        ...
                        <th colspan="3" align="right">FA : '.$sales.'</th>
                    </tr>
                </table>';
...
$h_tabel='          <th bgcolor="#cccccc" colspan="1"><h4>Hari</h4></th>
                    ...
                    <th bgcolor="#cccccc" colspan="2"><h4>Pengurus</h4></th>
                    <th bgcolor="#cccccc" colspan="1"><h4>Luar Kota</h4></th>
...
$qAct = mysql_query("SELECT a.day_name, a.db_date, SUBSTR(b.nama_perush, 1, 22) AS nama_perush,
                                  ...
                                  LEFT JOIN ( SELECT d.tgl_aktivitas, a.id_pelanggan, a.nama_perush, a.nama_pengurus, a.jabatan,
                                                     a.id_kota, e.nama_kota, b.kategori_segmen, c.segmen,
                                                      (
                                                        ...
                                                        WHEN 'Telepon' THEN
                                                            '2'
                                                        WHEN 'Handling Complain' THEN
                                                            '3'
                                                        ELSE
                                                            '-'
                                                        END
                                                    ) AS id_aktivitas, d.aktivitas,
                                                    ...
                                                    IF (
                                                     ...
                                                     d.keterangan, d.tgl_kunjungan_berikut, a.salesserv
        ...
        $dataQact .= "  <tr>
                            ...
                            <td colspan=\"3\">$rAct[aktivitas] - $rAct[nama_perush]</td>
                            <td colspan=\"2\">$rAct[nama_pengurus]</td>
                            <td>$rAct[luar]</td>
