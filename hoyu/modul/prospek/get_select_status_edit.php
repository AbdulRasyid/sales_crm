...
<div class="row">
	...
	<div class="col-md-3">
		<div class="form-group">
			...
			<input type="text" class="form-control" name="tgl_estimasi" id ="tgl_estimasi" required>
		</div>
	</div>
	...
	<div class="col-md-3">
		<div class="form-group">
			...
			<input type="text" class="form-control" name="no_po" autocomplete="off" required>
		</div>
	</div>
...
<div class="row">
	...
	<div class="col-md-3">
		<div class="form-group">
			...
			<input type="text" class="form-control" name="no_nota" autocomplete="off" required>
		</div>
	</div>
...
<div class="row">
	...
	<div class="col-md-3">
		<div class="form-group">
			...
			<span class="help-block">*Upload Foto Saat Serah Terima Unit Dengan Customer </span>							
		</div>
	</div>
