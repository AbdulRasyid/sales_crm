				...
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						...
						<div class="portlet-body">
							...
							<?php
                           	$result = mysql_query("SELECT a.id_users,a.username,a.nama_lengkap,b.nama_grade,a.level,
                           								  a.email,a.no_telp,
															(
																CASE a.blokir
																WHEN 'N' THEN
												  ...
												  FROM	ms_users a
												  LEFT JOIN ms_grade b ON b.id_grade = a.id_grade
			...
			<?php
				...
				if(empty($error)){
					...
					$tambah=mysql_query("UPDATE ms_users SET tgl_masuk = NOW() , id_grade = 1, nama_lengkap = '$nama_lengkap',
					 							...
					 							level = '$level', sublevel = '$sublevel', kantor = '$kantor',
					 							grade = 'trainee' WHERE username = '$username' ") or die(mysql_error());
				if($tambah){
