				...
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						...
						<div class="portlet-body">
							...
							<?php
                           	$result = mysql_query("SELECT * FROM tb_database WHERE deleted_flag = 0 AND divisi = '$_SESSION[divisi]'ORDER BY id_database DESC");
						...
						<div class="portlet-body form">
							...
							<form action="#" method="post">
								...
								<div class="form-actions">
									...
									<a href="?module=database"><button type="button" class="btn default">Cancel</button></a>
								</div>
							</form>
							<!-- END FORM-->
						</div>
