				...
				<div class="col-md-5">
					<div class="portlet box red">
						<div class="portlet-title">
							<div class="caption">
								<i class="icon-settings"></i> Form Tambah Aktivitas Unit
							</div>
							<ul class="nav nav-tabs">
								...
								<li  <?php if($_GET['aktivitas'] == "add_survey") { echo 'class="active"' ; } ?>>
							...
							<div class="tab-content">
								...
								<div class="skin skin-square">
									...
									<?php
										...
										$tambah=mysql_query("INSERT INTO tb_aktivitas_harian_unit (id_aktivitas_harian,id_pelanggan,tgl_aktivitas,aktivitas,keterangan,bukti_visit,tgl_kunjungan_berikut,created_by,created_date,deleted_flag)  VALUES('','$id_pelanggan','$tgl_aktivitas','visit','$keterangan','$gambar','$tgl_kunjungan_berikut','$_SESSION[username]',NOW(),0)") or die(mysql_error());
										if($tambah){
										header('location:?module=data_customer&act=detail&id_pelanggan='.$id_pelanggan.'&notif=1');
