		...
		<div class="page-content">
			...
			<?php
				...
				$result = mysql_query("SELECT a.id_prospek,a.id_pelanggan,a.tgl_prospek,a.no_prospek,b.id_kendaraan,b.merk,
											  ...
											  j.id_kota_perusahaan,j.kota_perusahaan,h.id_dp,h.dp,w.tenor,i.id_status_prospek,
											  i.status_prospek,a.tgl_touch,a.tgl_nego,a.tgl_hot,x.tgl_spk,y.tgl_po,
											  z.tgl_do,z.no_rangka,z.no_mesin,z.no_nota,z.serah_terima1,z.serah_terima2,
											  a.estimated_delivery,a.status,
									   ...
									   LEFT JOIN ms_leasing_kota j ON j.id_kota_perusahaan = w.id_kota_perusahaan
						...
						$lost = mysql_query("SELECT MAX(id_prospek) AS getID FROM tb_prospek WHERE id_pelanggan = $id_pelanggan");   
          				$r_lost = mysql_fetch_array($lost);
							...
							mysql_query("INSERT INTO tb_lost(id_lost,id_pelanggan,id_prospek,id_p_analisa_lost,id_analisa_lost,
										 ...
										 VALUES('',$id_pelanggan,'$r_lost[getID]','$id_p_analisa_lost','$id_analisa',
				...
				<div class="portlet-body form">
					<form action="#" enctype="multipart/form-data" method="post">
						...
						<div class="form-actions right">
							...
							<a href="?module=data_customer&act=detail&id_pelanggan=<?php echo $id_pelanggan ; ?>"
							type="button" class="btn default">Cancel</a>
							<button type="submit" class="btn blue"><i class="fa fa-check"></i> Submit</button>
						</div>
					</form>
				...
				if($id_pembayaran == '1'){
					if($id_status_prospek == '4') {
						...
						$tambah=mysql_query("UPDATE tb_prospek SET id_kendaraan = '$id_kendaraan', 
													id_tipe_kendaraan = '$id_tipe_kendaraan',id_warna = '$id_warna',
													id_karoseri = '$id_karoseri',no_prospek = '$no_prospek',
													test_drive = '$test_drive',jml_kendaraan = jml_kendaraan + '$jumlah',
													id_pembayaran = '$id_pembayaran', id_status_prospek = '$id_status_prospek',
													modified_by = '$_SESSION[username]', modified_date = NOW(),
													estimated_delivery = '$tgl_estimasi', status = '$status', 
													no_purchase_order = '$no_po', tgl_purchase_order = '$tgl_po',
													cek_money ='$cek_money', cek_auth = '$cek_auth', cek_need = '$cek_need',
													ket_money = '$ket_money', ket_auth = '$ket_auth',ket_need = '$ket_need'
											 WHERE id_prospek = $id_prospek ")  
											 OR DIE(mysql_error());
						...
						$tambah=mysql_query("UPDATE tb_prospek SET id_kendaraan = '$id_kendaraan', 
							...
							mysql_query("INSERT INTO tb_po(id_po,id_prospek,tgl_estimasi,status,tgl_po,no_po,created_by,
															created_date)  
										 VALUES('','$id_prospek','$tgl_estimasi','$status','$tgl_po','$no_po','$_SESSION[username]',NOW())")
										 OR DIE(mysql_error());
												...
												<option value="">Pilih Status Prospek</option>
													<?php
														...
														if($_SESSION[level] == 'admin' OR $_SESSION[level] == 'manager'){
															if ($array['id_pembayaran'] == '2'){
																$sql=mysql_query("SELECT * FROM ms_status_prospek WHERE id_status_prospek IN (4,6,7) ORDER BY urutan");
															} elseif ($array['id_pembayaran'] == '1') {
																$sql=mysql_query("SELECT * FROM ms_status_prospek WHERE id_status_prospek IN (4,5,6) ORDER BY urutan");
															}
														} elseif ($_SESSION[level] == 'sales') {
															$sql=mysql_query("SELECT * FROM ms_status_prospek WHERE id_status_prospek IN (4,6) ORDER BY urutan");
														}
			...
			<?php
				...
				if(empty($error)){
					...
					$sumber1 = $_FILES['serah_terima1']['tmp_name'];
                    $target1 = 'picture/serah_terima/unit/';
                    $gambar1 = $_FILES['serah_terima1']['name'];
                    
                    move_uploaded_file($sumber1, $target1.$gambar1);

                    $sumber2 = $_FILES['serah_terima2']['tmp_name'];
                    $target2 = 'picture/serah_terima/unit/';
                    $gambar2 = $_FILES['serah_terima2']['name'];
                    
                    move_uploaded_file($sumber2, $target2.$gambar2);
				...
				if($id_pembayaran == '1'){
					if($id_status_prospek == '7') {
						$tambah=mysql_query("UPDATE tb_prospek SET id_kendaraan = '$id_kendaraan', 
								...
								mysql_query("UPDATE tb_po SET tgl_estimasi='$tgl_estimasi',status='$status',
															  tgl_po='$tgl_po',no_po='$no_po', modified_by = '$_SESSION[username]',
															  modified_date = NOW() 
											 WHERE id_prospek = $id_prospek")
										 	 OR DIE(mysql_error());
				...
				<div class="portlet-body form">
					<form action="#" enctype="multipart/form-data" method="post">
											...
											<select class="form-control" name="id_cabang" id="id_cabang" required>
												<option value="">- Pilih Cabang -</option>
													<?php
														...
														if($id == $array['id_kota_perusahaan']){
														echo '<option value="'.$id.'" selected="selected">'.$row['id_kota_perusahaan'].'</option>';
														} else {
														echo '<option value="'.$id.'">'.$row['id_kota_perusahaan'].'</option>';
																		}
																	}
													?>
											</select>				
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<select class="form-control status_edit" name="id_status_prospek">
												<option value="">Pilih Status Prospek</option>
													<?php
														$sql=mysql_query("SELECT * FROM ms_status_prospek WHERE id_status_prospek IN (5,7,6) ORDER BY urutan");
								...
								<div class="row">
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="tgl_estimasi" id ="tgl_estimasi" value="<?php echo $array['tgl_estimasi']; ?>">
										</div>
									</div>
									...
									<div class="col-md-3">
										<div class="form-group">
											<label>Status</label>
											<input type="text" class="form-control" autocomplete="off" name="status" value="<?php echo $array['status']; ?>">
										</div>
									</div>

									<div class="col-md-3">
										<div class="form-group">
											<label class="control-label">Tanggal Purchase Order</label>
											<input type="text" class="form-control" name="tgl_po" id ="tgl_po" value="<?php echo $array['tgl_po']; ?>">
										</div>
									</div>
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<input type="text" class="form-control" autocomplete="off"  name="no_po" value="<?php echo $array['no_po']; ?>">
										</div>
									</div>
						...
						<div class="form-actions right">
							...
							<a href="?module=data_customer&act=detail&id_pelanggan=<?php echo $id_pelanggan ; ?>" type="button" class="btn default">Cancel</button></a>
							<button type="submit" class="btn blue"><i class="fa fa-check"></i> Submit</button>
						</div>
					</form>
						...
						<div class="form-body">
								...
								<div class="row">
									<div class="col-md-3">
										...
										<div class="form-group">
												<label class="control-label">Foto Serah Terima 1</label>
												
												<div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
												<?php if (empty($array['serah_terima1'])) { ?>
													<img src="picture/bukti/noimage.png" >
												<?php } else { ?>
													<img src="picture/serah_terima/unit/<?php echo $array['serah_terima1'];?>" >
												<?php } ?>
												</div>
												<br><br>
												<span class="help-block">Foto Serah Terima Sebelumnya </span>
												<br>
													<div class="fileinput fileinput-new" data-provides="fileinput">
														<span class="input-group-addon">
															<input type="file" name="serah_terima1">
														</span>												
													</div>
													<span class="help-block">*Upload Foto Saat Serah Terima Dgn Customer </span>							
										</div>
									...
									<div class="col-md-3">
										...
										<div class="form-group">
												<label class="control-label">Foto Serah Terima 2</label>
												
												<div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
												<?php if (empty($array['serah_terima2'])) { ?>
													<img src="picture/bukti/noimage.png" >
												<?php } else { ?>
													<img src="picture/serah_terima/unit/<?php echo $array['serah_terima2'];?>" >
												<?php } ?>
												</div>
												<br><br>
												<span class="help-block">Foto Serah Terima Sebelumnya </span>
												<br>
													<div class="fileinput fileinput-new" data-provides="fileinput">
														<span class="input-group-addon">
															<input type="file" name="serah_terima2">
														</span>												
													</div>
													<span class="help-block">*Upload Foto Saat Serah Terima Dgn Customer </span>							
											</div>
			...
			<div class="row">
				<div class="col-md-5">
					<div class="portlet box red">
						<div class="portlet-title">
							<div class="caption">
								<i class="icon-settings"></i> Join Visit SPV
							</div>
						</div>
						<div class="portlet-body form">
							<div class="tab-content">
          						<div class="skin skin-square">
          							...
          							<?php
										...
										$tgl_join_visit = $_POST['tgl_join_visit'];
										$keterangan = addslashes( $_POST['keterangan'] );
										$action_plan = addslashes( $_POST['action_plan'] );

											$update=mysql_query("INSERT INTO tb_join_visit (id_join_visit,id_prospek,tgl,keterangan,action_plan) VALUES('','$id_prospek','$tgl_join_visit','$keterangan','$action_plan')") or die(mysql_error());
									...
									<form action="#" enctype="multipart/form-data" method="post">
										<div class="form-body">							
											...
											<div class="form-group input-medium">
												<label class="control-label">Tanggal Join Visit</label>
												<div class="input-group date date-picker" data-date-format="yyyy-mm-dd">
												<input type="text" class="form-control" name="tgl_join_visit" autocomplete="off" required>
												<span class="input-group-btn">
												<button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
												</span>
												</div>
											...
											<div class="form-group input-xlarge">
												...
												<input type="text" class="form-control" name="action_plan" autocomplete="off" placeholder="Keterangan" required>
											</div>								
